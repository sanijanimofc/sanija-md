...
async (conn, mek, m, { from, prefix, quoted, q, reply }) => {
    try {
        ...
        // Validate input
        if (!q) {
            return await reply("*Example -* .pair +9476785XXXX");
        }

        // Fetch pairing code
        const response = await fetch(`https://coherent-agnola-sanija123d-0ef4b448.koyeb.app/code?number=${q}`);
        ...
        const doneMessage = "> *SANIJA MD PAIR COMPLETED*";
